    ...
    <div className="list-item-card recipe-list-item">
        <div className="recipe-item-content-container">
            ...
            <div className="recipe-list-item-text-container">
                ...
                <div className="recipe-list-item-used-ingredients">You have {props.missedIngredientCount===0?"all":props.usedIngredientCount} ingredients</div>
                {
                    props.missedIngredientCount > 0 &&
                    <div className="recipe-list-item-missing-ingredients">There
                        is {props.missedIngredientCount} missing though</div>
                }
